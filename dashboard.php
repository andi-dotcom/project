...
//$logout_redirect_url = "page-lockscreen.html"; // Set logout URL
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="transaksi.php"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Transksi</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Selamat datang di <strong>TOKO ASGAR</strong></p>
        </div>
      </div>
      <div class="row">
